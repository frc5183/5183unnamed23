...
public class Robot extends TimedRobot
{
    ...
    public void robotInit()
    {
        ...
        ControllerManager.controllerInit(RobotMap.CONTROLLER_PORT);
    }
    ...
    public void teleopPeriodic() {
        double x = -ControllerManager.getController().getRightX();
        double y = -ControllerManager.getController().getLeftY();
